...
data class VCSSettings(
    ...
    val versionControlSystemRoots: List<VersionControlSystemRoot> = emptyList(),
) {
    ...
    fun hasNoConfiguredVCSRoot(): Boolean =
        versionControlSystemRoots.isEmpty() ||
            (versionControlSystemRoots.size == 1 && versionControlSystemRoots[0].vcsPath == null)
}
